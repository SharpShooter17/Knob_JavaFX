...
public class Knob extends Control{
    ...
    public Knob(){
        ...
        @Override
        public void handle(MouseEvent event) {           
                setValue( getValue() + event.getX() - getDraggStarted() );
                setDraggStarted(event.getX());
            }
        });
        
        this.setValue(_maxValue);
    }
    ...
    public void setDraggStarted(double value)    {
        this._draggStarted = value;
    }
    
    public double getDraggStarted(){
        return this._draggStarted;
    }
        @Override
